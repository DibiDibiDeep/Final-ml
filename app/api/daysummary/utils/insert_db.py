...
if utility.has_collection(collection_name):
    ...
    collection = Collection("day_info")
else:
    ...
    dummy = [
        ...
        },
        {
            ...
            "date": "2024-09-06",
            "role": "parents",
            # "emotion": "자부심과 기대감이 넘쳐요",
            # "health": "활기차고 건강해요",
            # "nutrition": "아침은 통곡물 샌드위치, 점심은 회사 구내식당에서 한식, 저녁은 아이와 함께 만든 피자를 먹었어요.",
            # "activities": ["출근", "프레젠테이션", "요리 시간", "취침 전 독서"],
            # "social": "중요한 프레젠테이션에서 좋은 평가를 받았어요. 저녁에는 아이와 함께 요리하며 대화를 나눴습니다.",
            # "special": "아이가 처음으로 피자 도우를 직접 만들었어요. 함께 요리하는 시간이 정말 특별했습니다.",
            # "keywords": ["프레젠테이션", "요리", "피자", "성취", "가족시간"],
        ...
        },
        {
            ...
            # "emotion": "신나고 뿌듯해요",
            # "health": "건강하고 활기차요",
            # "nutrition": "학교에서 점심을 맛있게 먹었고, 저녁에는 직접 만든 피자를 먹었어요!",
            # "activities": ["학교 수업", "과학 실험", "피자 만들기", "책 읽기"],
            # "social": "과학 실험을 하면서 친구들과 협력했어요. 저녁에는 부모님과 함께 요리하며 즐거운 시간을 보냈어요.",
            # "special": "처음으로 피자 도우를 직접 만들었어요. 너무 재미있고 맛있었어요!",
            # "keywords": ["과학실험", "피자", "요리", "성취감", "가족시간"],
        ...
        },
        {
            ...
            "date": "2024-09-12",
            "role": "parents",
            # "emotion": "조금 피곤하지만 만족스러워요",
            # "health": "허리가 약간 아프지만 괜찮아요",
            # "nutrition": "아침은 오트밀, 점심은 동료들과 외식, 저녁은 간단한 샐러드를 먹었어요.",
            # "activities": ["출근", "프로젝트 미팅", "아이 숙제 도와주기", "집안일"],
            # "social": "점심에 동료들과 즐거운 대화를 나눴어요. 저녁에는 아이의 학교생활에 대해 이야기를 들었습니다.",
            # "special": "아이가 어려운 수학 문제를 스스로 해결했어요. 아이의 성장을 느낄 수 있어 뿌듯했습니다.",
            # "keywords": ["프로젝트", "외식", "숙제", "성장", "대화"],
        ...
        },
        {
            ...
            "date": "2024-09-12",
            "role": "child",
            # "emotion": "자신감 넘치고 행복해요",
            # "health": "건강하고 활기차요",
            # "nutrition": "학교 급식으로 영양 가득한 비빔밥을 먹었어요. 간식으로는 사과를 먹었어요.",
            # "activities": ["수학 수업", "체육 시간", "미술 동아리", "숙제하기"],
            # "social": "체육 시간에 친구들과 농구를 하며 즐거운 시간을 보냈어요. 미술 동아리에서 새로운 친구도 사귀었어요.",
            # "special": "어려운 수학 문제를 혼자 힘으로 풀었어요. 선생님께 칭찬을 받아서 정말 기뻤어요!",
            # "keywords": ["수학", "농구", "미술", "성취감", "새 친구"],
        ...
        },
        {
            ...
            "date": "2024-09-18",
            "role": "parents",
            # "emotion": "약간 긴장되지만 희망적이에요",
            # "health": "목에 약간 통증이 있어요",
            # "nutrition": "아침은 과일 스무디, 점심은 회사 구내식당, 저녁은 아이와 함께 만든 김치찌개를 먹었어요.",
            # "activities": ["중요 회의 준비", "프레젠테이션", "장보기", "요리"],
            # "social": "중요한 회의에서 새로운 아이디어를 제안했어요. 저녁에는 아이와 함께 요리하며 대화를 나눴습니다.",
            # "special": "아이가 처음으로 김치찌개 만드는 것을 도와줬어요. 함께 요리하는 모습이 정말 대견했습니다.",
            # "keywords": ["회의", "프레젠테이션", "장보기", "요리", "대화"],
        ...
        },
        {
            ...
            "date": "2024-09-18",
            "role": "child",
            # "emotion": "호기심 가득하고 즐거워요",
            # "health": "건강하고 원기왕성해요",
            # "nutrition": "학교에서 균형 잡힌 점심을 먹었고, 저녁은 엄마 아빠와 함께 만든 김치찌개를 먹었어요.",
            # "activities": ["과학 실험", "독서 시간", "장보기", "요리 돕기"],
            # "social": "과학 실험을 하면서 친구들과 협력했어요. 저녁에는 부모님과 함께 장을 보고 요리를 했어요.",
            # "special": "처음으로 김치찌개 만드는 것을 도왔어요. 요리하는 게 정말 재미있었어요!",
            # "keywords": ["과학실험", "독서", "장보기", "요리", "협력"],
        ...
        },
        {
            ...
            # "emotion": "뿌듯하고 감사해요",
            # "health": "컨디션이 좋아요",
            # "nutrition": "아침은 통곡물 시리얼, 점심은 동료와 샐러드, 저녁은 가족과 함께 삼겹살을 구워 먹었어요.",
            # "activities": ["업무 마무리", "동료와 점심", "가족 저녁 식사", "아이와 산책"],
            # "social": "점심에 동료와 중요한 프로젝트 성공을 축하했어요. 저녁에는 가족과 오랜만에 외식을 즐겼습니다.",
            # "special": "아이가 학교에서 받은 '이 달의 모범학생' 상장을 보여줬어요. 정말 자랑스러웠습니다.",
            # "keywords": ["프로젝트", "축하", "외식", "산책", "모범학생"],
        ...
        },
        {
            ...
            # "emotion": "자랑스럽고 행복해요",
            # "health": "건강하고 활기차요",
            # "nutrition": "학교에서 영양가 있는 점심을 먹었고, 저녁은 가족과 함께 맛있는 삼겹살을 먹었어요.",
            # "activities": ["수업 참여", "모범학생 시상식", "가족 외식", "산책"],
            # "social": "친구들과 즐겁게 놀았고, 선생님께 칭찬을 받았어요. 저녁에는 가족과 즐거운 시간을 보냈어요.",
            # "special": "'이 달의 모범학생' 상을 받았어요. 정말 기쁘고 자랑스러웠어요!",
            # "keywords": ["모범학생", "시상식", "외식", "산책", "가족시간"],
